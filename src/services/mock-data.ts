  ...
  data: [
    {
      ...
      presentation: {
        ...
        suggestionTitle: "United Kingdom",
        subtitle: "",
      },
      navigation: {
        entityId: "29475375",
    ...
    },
    {
      ...
      presentation: {
        title: "Manchester",
        suggestionTitle: "Manchester (MAN)",
        subtitle: "United Kingdom",
      },
      navigation: {
        entityId: "95673540",
...
export const MOCK_FLIGHT_PRICES = {
  status: true,
  timestamp: Date.now(),
  data: {
    flights: {
      ...
      days: [
        ...
        ...Array.from({ length: 30 }, (_, i) => {
          const day = `2025-06-${String(i + 1).padStart(2, "0")}`;
          return {
            day,
            group: ["low", "medium", "high"][Math.floor(Math.random() * 3)],
            price: +(100000 + Math.random() * 50000).toFixed(2),
          };
        }),
        // July
        ...Array.from({ length: 31 }, (_, i) => {
          const day = `2025-07-${String(i + 1).padStart(2, "0")}`;
          return {
            day,
            group: ["low", "medium", "high"][Math.floor(Math.random() * 3)],
            price: +(110000 + Math.random() * 60000).toFixed(2),
          };
        }),
        // August
        ...Array.from({ length: 31 }, (_, i) => {
          const day = `2025-08-${String(i + 1).padStart(2, "0")}`;
          return {
            day,
            group: ["low", "medium", "high"][Math.floor(Math.random() * 3)],
            price: +(120000 + Math.random() * 70000).toFixed(2),
          };
        }),
      ],
      currency: "NGN",
...
export const SEARCH_FLIGHT_RESPONSE = {
  status: true,
